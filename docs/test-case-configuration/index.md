---
id: test-case-configuration
title: 'Test Case & Configuration Module'
sidebar_position: 6
hide_table_of_contents: true
sidebar_label: Test Case & Configuration
slug: /test-case-configuration
description: 'Design and orchestrate complete test execution flows'
---
...
- [Test Cases](./test-case-configuration/test-cases)
- [Creating a Test Case](./test-case-configuration/creating-test-case)
- [Step Settings](./test-case-configuration/step-settings)
- [Advanced Features](./test-case-configuration/advanced-features)
- [Best Practices](./test-case-configuration/best-practices)
- [Managing Test Cases](./test-case-configuration/managing-test-cases)
